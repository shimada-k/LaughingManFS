...
#TODO
# 新しいファイルを作ると実行許可フラグが更新されるみたいだ。
# 新規にファイルを作って即座に実行可能になるように改修
#==========================================================

class LaughingEngine

	# コンストラクタ
	# path:格納する画像のパス（指定なしだとカレントのlaughing_man.pngを読みにいく）
	# pos:デフォルトのオフセット
